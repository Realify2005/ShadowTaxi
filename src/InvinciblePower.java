...
public class InvinciblePower {
    ...
    public InvinciblePower(int x, int y, Properties properties) {
        ...
        IMAGE = new Image(properties.getProperty("gameObjects.invinciblePower.image"));
        RADIUS = Double.parseDouble(properties.getProperty("gameObjects.invinciblePower.radius"));
